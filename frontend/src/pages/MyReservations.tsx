            ...
            {reservations.map(reservation => (
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="font-bold text-lg">Room {reservation.room_id || reservation.room}</h3>
                    <p className="text-gray-600">
                      {formatDateTime(reservation.start_time)} - {formatDateTime(reservation.end_time)}
                    </p>
                    {reservation.purpose && (
                      <p className="mt-2"><strong>Purpose:</strong> {reservation.purpose}</p>
                    )}
                    <p><strong>Attendees:</strong> {reservation.num_attendees}</p>
                  </div>
                  <div>
